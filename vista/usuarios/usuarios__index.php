...
<head>
    ...
    <title>Gestionar Usuarios Levapan</title>
</head>
<body>
    ...
    <main>
        ...
        <div class="acciones">
            ...
            <ul class="lista-items">
                ...
                <a href="usuarios__registrar.php"><li class="items">
                    <img src="../imagenes/iconos/consultar_clientes.svg"> 
                    <p>Registrar nuevo usuario del sistema</p>
                </li></a>

                <a href="usuarios__consultar.php">
                    <li class="items">
                    <img src="../imagenes/iconos/registrar_clientes.svg">
                    <p>Consultar o actualizar usuarios del sistema</p>
                </li></a>           
